                ...
                <form action="<?= base_url('kelas/add'); ?>" method="post">
					<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="id_wali" name="id_wali" value=" <?= set_value('id_wali'); ?>">
								<small class="text-danger">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="id_kelas" name="id_jurusan" value=" <?= set_value('id_jurusan'); ?>">
								<small class="text-danger">
