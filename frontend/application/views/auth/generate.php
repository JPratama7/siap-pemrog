...
<div class="kotak_login">
	...
	<form action="<?php echo base_url('auth/generate') ?>" method="POST">
		...
		<input type="text" disabled name="keyapi" class="form_login" placeholder="Password .."
			   value="<?= empty($key) ? '' : $key ?>">
	...
	<a href="<?= base_url('auth/logout') ?>">
		<button class="tombol_login">Logout</button>
	</a>
	<br/>
	<br/>
	<a href="<?= base_url('mahasiswa') ?>">
		<button class="tombol_login">Main Menu</button>
	</a>
