...
class MK extends CI_Controller
{
    ...
    public function index()
	{
        ...
        $data['data_jadwal'] = $this->MK_model->getAll();
...
//        );
    ...
    public function detail($npm)
    {
        $data = array(
            ...
            'data_mahasiswa' => $this->MK_model->getById($npm)
        );
        return array(
            $this->load->view('templates/header', $data),
            $this->load->view('templates/menu'),
...
//            );
    ...
    public function edit($npm)
    {
        ...
        $data["data_mahasiswa"] = $this->MK_model->getById($npm);
        ...
        if ($this->form_validation->run() == false) {
            ...
            $update = $this->MK_model->update($data, $npm);
    ...
    {
        $delete = $this->MK_model->delete($npm);
